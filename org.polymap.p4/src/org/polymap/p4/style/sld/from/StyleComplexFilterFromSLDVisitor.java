 ...
 *
 */
public class StyleComplexFilterFromSLDVisitor
        implements FilterVisitor {

    private final StyleCompositeFilter styleComplexFilter;


    /**
     * @param styleFilterConfiguration
     */
    public StyleComplexFilterFromSLDVisitor( StyleCompositeFilter styleComplexFilter ) {
        this.styleComplexFilter = styleComplexFilter;
    }
    ...
    public Object visit( And filter, Object extraData ) {
        StyleCompositeFilter complexFilter = styleComplexFilter.complexFilters.createElement( f -> {
        ...
        filter.getChildren().stream().map( f -> f.accept( styleComplexFilterFromSLDVisitor, null ) );
        return null;
    }
    ...
    private void handleBinaryFilter( BinaryComparisonOperator filter, String opName ) {
        ...
        Object value = (filter.getExpression2() instanceof Literal) ? ((Literal)filter.getExpression2()).getValue()
                : null;
        StyleFilter simpleFilter = styleComplexFilter.simpleFilters.createElement( f -> {
